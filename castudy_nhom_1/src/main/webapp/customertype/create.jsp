...
<div class="row m-4 ">
    ...
    <div class="col-md-6 " style="float: right">
        <h3 style="margin-bottom: 10px">Thêm mới loại khách</h3>
        <form method="post" class="b1">
            <div class="mb-3 row">
                <label for="id" class="col-sm-4 col-form-label" style="font-weight: bold">Mã loại khách<span
                        style="color: red">*</span></label>
                <div class="col-sm-8">
                    <input type="text" name="code" class="form-control" id="id" required>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="name" class="col-sm-4 col-form-label" style="font-weight: bold">Tên loại khách<span
                        style="color: red">*</span></label>
                <div class="col-sm-8">
            ...
            <div class="mb-3 row">
                <label for="des" class="col-sm-4 col-form-label" style="font-weight: bold">Ưu đãi<span
                        style="color: red">*</span></label>
                <div class="col-sm-8">
                    <input type="text" name="endow" class="form-control" id="des" style="height: 40px" required>
                </div>
            </div>
